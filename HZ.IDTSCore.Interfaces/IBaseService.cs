...
namespace HZ.IDTSCore.Interfaces
{
    ...
    {
        //public void SetUs(SessionInfo session);
        ...
        /// <returns></returns>
        int Add(T parm, SqlSugarClient tranDb = null);
        ...
        /// <param name="where">条件表达式树</param>
        /// <returns></returns>
        List<T> GetWhere(Expression<Func<T, bool>> where, Expression<Func<T, object>> order=null, string orderEnum = "Asc");
        ...
        /// <returns></returns>
        int Update(T parm, SqlSugarClient tranDb = null);
        ...
        /// <returns></returns>
        int Update(Expression<Func<T, bool>> where, Expression<Func<T, T>> columns, SqlSugarClient tranDb = null);
        ...
        /// <returns></returns>
        int Delete(Expression<Func<T, bool>> where, SqlSugarClient tranDb = null);
        #endregion

        UserSession GetSessionInfo();

        string GetRuleNo(string ruleName,string otherSuffix="");

        public List<string> GetRuleNos(string ruleName, int count, string otherSuffix = "");
        ApiResult GetUserByRole(string roleCode);
    }
}