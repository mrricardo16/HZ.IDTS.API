...
{
    public class EditLogService: IEditLogService
    {
        //public bool AddLog(string activeType,string updateId,string opNo,string orderType,object oldObj,object newObj,string userCode)
        //{
        //    try
        //    {
