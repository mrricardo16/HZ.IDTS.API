    ...
    class DtsService : BaseService<tn_dts_logs>, IDtsService
    {
        ...
        public Newtonsoft.Json.Linq.JObject GetSystemconfig(LocationRealMonitorViewModel locationRealMonitorViewModel)
        {
            ...
            try
            {
                ...
                string groundJson = "";
                LogHelper.Info("【locationRealMonitorViewModel.stock】：" + JsonConvert.SerializeObject(locationRealMonitorViewModel.stock));
                LogHelper.Info("【dataMemberList】：" + JsonConvert.SerializeObject(dataMemberList));
