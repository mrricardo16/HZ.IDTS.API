...
namespace HZ.CommonUtil
{
    ...
    public class ServiceLocator
    {
        ...
        public static IService GetService<IService>(string token="")
        {
            return _container.Resolve<IService>(new NamedParameter("token", token));
        }

        public static IService GetServiceByName<IService>(string name, string token = "")
        {
            return _container.ResolveNamed<IService>(name, new NamedParameter("token", token));
        }
